...
app.use([logger,authorize]) //triggers middle into every url req if the path isnt mentioned
//orders matters 
/*the path parameter in the method applies the middleware to every request 
after the api
TO pass multiple middleware we keep them in a array; order matters
*/
